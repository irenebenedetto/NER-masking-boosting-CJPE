...
if __name__ == '__main__':
    ...
    #new_df.to_csv(ds_train_path.split(".")[0]+'_sentences_UNMASKED_ENTITY.csv', index=False)
    print('Generate file: ', ds_train_path.split(".")[0]+'_sentences.csv')


# python code/sentence_splitter_no_NER.py --ds_train_path '~/data/legal/ILDC_expert_data/ILDC_expert_explain.csv'
# python code/sentence_splitter_no_NER.py --ds_train_path '~/data/legal/ILDC_single_entities_roberta_explain.csv'
