...
if __name__ == "__main__":
    ...
    model_paths = [
        ...
        "studio-ousia/luke-large-finetuned-conll-2003",     # LUKE large ft on CoNLL-2003
        "studio-ousia/luke-large-finetuned-open-entity",    # LUKE large ft on Open Entity
        "studio-ousia/luke-large-finetuned-tacred",         # LUKE large ft on TACRED
        "studio-ousia/mluke-large",                         # mLUKE large 
        "saibo/legal-roberta-base",                         # RoBERTa base pt on Legal Domain
        "Davlan/xlm-roberta-base-ner-hrl",                  # RoBERTa base multilingual ft on NER HRL
        "Jean-Baptiste/roberta-large-ner-english",          # RoBERTa large ft on NER
        "dslim/bert-base-NER",                              # BERT base ft on NER  
        "dslim/bert-large-NER",                             # BERT large ft on NER
        "nlpaueb/legal-bert-small-uncased",                 # BERT small pt on Legal Domain
        "nlpaueb/legal-bert-base-uncased",                  # BERT base pt on Legal Domain
        "nlpaueb/bert-base-uncased-contracts",              # BERT base ft on Contracts
        "nlpaueb/bert-base-uncased-echr",                   # BERT base ft on ECHR
        "nlpaueb/bert-base-uncased-eurlex",                 # BERT base ft on Eurlex
        "Davlan/bert-base-multilingual-cased-ner-hrl",      # BERT base multilingual ft on NER HRL
    ]
